    ...
    */
    ...
    'custom' => [
        ...
        'password_confirmation' => [
            'required' => '確認用パスワードを入力してください', // 確認用パスワード自体の必須チェック
            'same' => 'パスワードと確認用パスワードが一致しません', // 'confirmed'ルールが不一致の場合に'same'メッセージを参照することが多い
            // もしフレームワークのconfirmedがsameを自動的に参照しない場合は以下も追加
            'confirmed' => 'パスワードと確認用パスワードが一致しません',
        ],
    ],
